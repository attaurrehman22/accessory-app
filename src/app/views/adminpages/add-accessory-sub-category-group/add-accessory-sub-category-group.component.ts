...
@Component({
  selector: 'app-add-accessory-sub-category-group',
  templateUrl: './add-accessory-sub-category-group.component.html',
  styleUrls: ['./add-accessory-sub-category-group.component.css']
})
export class AddAccessorySubCategoryGroupComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AddAccessorySubCategoryGroupComponent>,
    ...
    if (data?.param == "Edit") {
      ...
      this.categoryForm.patchValue({
        category_group_id: data.data.category_group_id,
        name: data.data.name,
        slug: data.data.slug,
  ...
  onSubmit(): void {
    ...
    if (this.categoryForm.valid) {
      ...
      if (this.paramVal == "Create") {
        this.http.addAdminAccessroiesSubCategoryGroups(this.categoryForm.value).subscribe(
          (res) => {
        ...
        this.http
          .editAdminAccessroiesSubCategoryGroups(this.categoryForm.value, this.categoryID)
          .subscribe(
            (res) => {
              this.alertService.showAlert(
                "success",
